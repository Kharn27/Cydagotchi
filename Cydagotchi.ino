...
void updateNeeds(float dtSeconds) {
  ...
  currentPet.age        += dtSeconds / 60.0f;  // 60 s réelles = 1 jour virtuel
...
// Dessine le visage du pet en fonction de son humeur
void drawPetFace() {
  const char* face = "-_-";
  ...
  tft.drawString(face, SCREEN_W - 70, 70);
}
